...
public class ProductUpdaterTest {
    ...
    void shouldNotUpdateProductIfBothQuantityAndPriceAreNull() throws ExecutionException, InterruptedException {
        assertEquals(Messages.INVALID_PRICE_AND_QUANTITY.getMessage(), productUpdater.updateQuantityAndPrice(new ProductUpdateDTO(UUID.randomUUID(), null, null)).get().getFirst());
    }
    ...
    void shouldNotUpdateOnProductNotFound() throws ExecutionException, InterruptedException {
        ...
        assertEquals(Messages.PRODUCT_NOT_FOUND.getMessage(), productUpdater.updateQuantityAndPrice(new ProductUpdateDTO(UUID.randomUUID(), 100, null)).get().getFirst());
    }
    ...
    void shouldUpdateProductAndEmitEvent() throws ExecutionException, InterruptedException {
        ...
        productUpdater.updateQuantityAndPrice(new ProductUpdateDTO(UUID.randomUUID(), 100, null)).get();
